...
export default function Profile() {
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto pb-20">
      <h2 className="text-2xl font-bold text-emerald-800">Mein Profil</h2>
      ...
      <div className="bg-white rounded-2xl shadow-md border border-emerald-100 overflow-hidden">
        ...
        <div className="bg-emerald-50 p-6 flex flex-col items-center justify-center border-b border-emerald-100">
          <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-emerald-600 text-4xl font-bold shadow-sm mb-3 border-4 border-white">
        ...
        <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all bg-gray-50 focus:bg-white"
                  placeholder="Wie möchtest du heißen?"
                />
              </div>
              <p className="text-xs text-gray-500 mt-1 ml-1">Dieser Name wird im Koran-Plan angezeigt.</p>
            </div>

            {message && (
              <div className={`p-4 rounded-xl text-sm font-medium animate-fade-in ${message.includes('Fehler') ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'}`}>
                {message}
              </div>
            )}
          ...
          <div className="border-t border-gray-100 pt-6 space-y-3">
            <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Account Details</h4>
          ...
          <button 
            onClick={() => signOut()}
            className="w-full mt-4 px-4 py-3 text-red-600 border border-red-200 rounded-xl hover:bg-red-50 transition-colors font-semibold flex items-center justify-center gap-2"
          >
            Abmelden
          </button>
        </div>
