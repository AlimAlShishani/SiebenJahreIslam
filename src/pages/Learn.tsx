        ...
        {levels.map((level, index) => {
          ...
          return (
            <div key={level.id} className="relative">
              {isLocked ? (
                <div className="bg-gray-100 p-6 rounded-xl shadow-sm border border-gray-200 opacity-75 flex items-center justify-between cursor-not-allowed">
                  <div>
                ...
                >
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-emerald-100 hover:border-emerald-300 transition-all hover:shadow-md flex items-center justify-between relative overflow-hidden">
                    {/* Progress Background */}
                    <div 
                    ...
                    <div className="bg-emerald-50 p-3 rounded-full group-hover:bg-emerald-100 transition-colors">
                      {level.level_number === 1 ? <Book size={24} className="text-emerald-600" /> :
                       level.level_number === 2 ? <Volume2 size={24} className="text-emerald-600" /> :
